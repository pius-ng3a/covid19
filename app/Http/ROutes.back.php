...
Route::get('start/user/login',['as'=>'auth_user','uses'=>'LoginController@login']);

Route::get('auth1/user/login',['as'=>'login','uses'=>'LoginController@login']);
Route::post('auth1/user/login',['as'=>'auth_user','uses'=>'LoginController@authenticateUser']);
