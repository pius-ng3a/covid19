    ...
    <div class="outer">
        <div class="center_rect " >
          <div class ="row">
              ...
              @endif
              {!! Form::model($user,['route'=>'save_contribution_update']) !!}
                  @include('partials.encrypt_form_csrf')
                   <h2 style="text-align: center;">{{trans('english.record_contribution')}}</h2>
                    <br>
                     <input hidden name="contribution_id" value="{{$user->contribution_id}}" />
                     <div class="form-group row">

                        <?php $users = \App\AlumniMember::getAllUsersOptions();
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-xs-9">
                          <select name="reciever_id" class="form form-control" required>
                            <option value="{{$user->reciever_id}}"><?php $reciever = \App\AlumniMember::findOrFail($user->reciever_id); echo $reciever->first_name." ".$reciever->last_name;?></option>
                            {!!  $users!!}
                          </select>
                      </div>
                  </div>
          ...
          <div>
                        <div class="form-group" style="text-align: center;">
                            {!! Form::submit(trans('english.save_update'),
