...
<head xmlns="http://www.w3.org/1999/html">
    ...
    <meta name="keywords" content="GHS Bafut,College,High school,bafut sub-division, government,secondary school, mezam division" />

    <title>{{trans('english.ghs')}}</title>
...
<!-- Start header  -->
<header id="mu-header"  style="background-color: #2ecc71;">
    <div class="container" style="background-color: #2ecc71;">
        <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="mu-header-top-left">
                                <div class="mu-top-email">
                                    ...
                                    <span>{{trans('english.schoolmail')}}</span>
                                </div>
                            ...
                            <div class="mu-header-top-right">
                                <nav>
                                    <ul class="mu-top-social-nav">
                                        <li><a target="__blank"  href="https://www.facebook.com/profile.php?id=100009344553147&fref=ts"><span class="fa fa-facebook"></span></a></li>
                                           ...
                                           ?>
                                            <li class="dropdown" style="background-color: inherit;">
                                                <a style="background-color: inherit;" href="#" class="dropdown-toggle" data-toggle="dropdown" style=" ">
                                                    <i class="fa fa-user"></i> {{Auth::user()->FirstName." " .Auth::user()->Last_Name}}<b class="caret"></b> </a>
                                        ...
                                        @else
                                            <li><a style="background-color: inherit;transformation: capitalize;" href="{{URL::to('start/user/login')}}"><i class="fa fa-lock"></i> {{trans('english.login')}}</a></li>
                                        @endif
